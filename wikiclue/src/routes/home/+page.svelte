...
<div class="home-page">
	...
	{#if $isOverlayOpen && levelsOpen}
		...
		>
			<p class="popup-description">
				In this game mode you will have unlimited time to try and complete 30 levels of increasing
				difficulty! Are you ready for the challenge?
			</p>
	...
	{#if $isOverlayOpen && dailyOpen}
		...
		>
			<p class="popup-description">
				Solve the daily problem as fast as possible! Come back everyday to build your streak!
			</p>
